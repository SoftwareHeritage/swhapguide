...
The same process can be done on depository and workbench.

### Decorate with Software Heritages badges

To add permanent links - *permalinks* - to code stored by Software Heritage we can use badges for the whole repository, to a specific release or commits as the following.


[![SWH](https://archive.softwareheritage.org/badge/origin/https://github.com/Unipisa/TAUmus)](/media/badge_archived_repo.svn) [![SWH](https://archive.softwareheritage.org/badge/swh:1:rel:f4339ba011f61cdd1af6dbb62cfb989cb12c9fbe;origin=https://github.com/Unipisa/TAUmus/)](/media/badge_archived_release.svn)
[![SWH](https://archive.softwareheritage.org/badge/swh:1:rev:be97ff85eb836773e0af90490bea376e52fce579;origin=https://github.com/Unipisa/TAUmus/)](/media/badge_archived_revision.svn)


For instance, the link to the whole repository, and its relative image, have the form of 

    https://archive.softwareheritage.org/browse/origin/$repo_url
    https://archive.softwareheritage.org/badge/origin/$repo_url

In practice, having a git repository, the badges can be generated by 

    git for-each-ref --sort -v:refname --format "
        [![SWH](https://archive.softwareheritage.org/badge/swh:1:rel:%(objectname);origin=$repo_url)](https://archive.softwareheritage.org/swh:1:rel:%(objectname);origin=$repo_url)
        [![SWH](https://archive.softwareheritage.org/badge/swh:1:rev:%(*objectname);origin=$repo_url)](https://archive.softwareheritage.org/swh:1:rev:%(*objectname);origin=$repo_url)
        " refs/tags

    echo "[![SWH](https://archive.softwareheritage.org/badge/origin/$repo_url)](https://archive.softwareheritage.org/browse/origin/$repo_url)"
